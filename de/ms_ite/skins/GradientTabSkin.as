...
//
//	Modified by Renaun Erickson 2007.02.07
//
////////////////////////////////////////////////////////////////////////////////

package de.ms_ite.skins
{
 ...
 */
public class GradientTabSkin extends Border
{
											  ...
											  fillColor1:uint):Object
	{
		...
		if (!cache[key])
		{
			...
			o.falseFillColorBright1 =
				ColorUtil.adjustBrightness(falseFillColor0, 20);
			o.falseFillColorBright2 =
				ColorUtil.adjustBrightness(falseFillColor1, 20);
		}
	 ...
	 *  Constructor.
	 */
	public function GradientTabSkin()
	{
		super();
	}
	...
	override protected function updateDisplayList(w:Number, h:Number):void
	{
		...
		// Selected Colors
		var downFillAlphas:Array = fillAlphas;
		var backgroundColors:Array = new Array();
		backgroundColors[0] = 0xFFFFFF;
		backgroundColors[1] = 0xFFFFFF;
		if( getStyle("backgroundGradientAlphas") != undefined && getStyle("backgroundGradientColors") != undefined ) {
			downFillAlphas = getStyle("backgroundGradientAlphas");
			backgroundColors = getStyle("backgroundGradientColors");
			var falseDownFillColors:Array = [];
			falseDownFillColors[0] = ColorUtil.adjustBrightness2(backgroundColors[0], -10);
			falseDownFillColors[1] = ColorUtil.adjustBrightness2(backgroundColors[1], -10)			
		}
		
		// Placehold styles stub.
		var falseFillColors:Array = []; /* of Number*/ // added style prop
		falseFillColors[0] = ColorUtil.adjustBrightness2(fillColors[0], -10);
...
//					backgroundColor, backgroundAlpha);
				...
				var downFillAlphasTmp:Array = [ downFillAlphas[0], downFillAlphas[1] ];

				// tab fill
				drawRoundRect(
					1, 1, w - 2, h - 2, cr2,
					falseDownFillColors, downFillAlphasTmp,
					verticalGradientMatrix(0, 2, w - 2, h - 6));
