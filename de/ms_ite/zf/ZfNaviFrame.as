...
class de.msite.ZfNaviFrame extends mx.core.UIComponent {
	static var symbolName:String = "ZfNaviFrame";
	static var symbolOwner:Object = de.msite.ZfNaviFrame;
	static var version:String = "0.1";
	var className:String = "ZfNaviFrame";
...
//		_root.debug( "DBG ZfNaviFrame: "+txt);
	}
...
*/		
	...
	public function setView() {
		...
		// disbale labels, so no extreem scaling can happen
